    ...
    <div className="section section__secondary" id="about">
        <div className="content-container">
            ...
            <div className="about__content">
                ...
                <p>I currently work as the lead web developer for the Shimberg Center, a department of the University of Florida aimed at promoting "safe, decent and affordable housing and related community development throughout the state of Florida."</p>
            </div>
        </div>
    </div>
);
