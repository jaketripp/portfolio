const apps = {
	...
	quickcopy: {
		...
		why:
			"I had run into the annoying scenario too many times where I had to copy and paste a lot of hard-to-distinguish things (think serial numbers, long URLs, etc) and thought that there had to be a better way.",
		coolFeature:
	...
	shimberg: {
		...
		why:
			"The site was in dire need of an update: I removed unnecessary files and redundancy from the codebase, I made the site fully responsive on all screen sizes, I standardized the routing, and I added minification, bundling, and compression to speed up the page load times.",
		coolFeature:
	...
	clearinghouse: {
		...
		why:
			"The site needed new features and a new infrastructure to support them. I removed unnecessary features, added new features, and improved the user experience and interface.",
		coolFeature:
	...
	elderdata: {
		...
		why:
			"We remade the existing site (most of which was written in Perl). Since we were such a small team, I was the lead developer - which was a really cool experience.",
		coolFeature:
	...
	distillr: {
		...
		why:
			"My friend and teammate, Kia, told me about the VIA 2018 Codeathon and it sounded like a great opportunity to participate in. We had been wanting to work together because we thought our skillsets would compliment each other. It also sounded more satisfying and convenient because the problems were local problems. It’s 2018, we make more decisions every single day than arguably any other time in history. Decisions are hard, and time is precious.  Distillr makes decision making easy.",
		coolFeature:
	...
	musicmaster: {
		...
		why:
			"I was initially building a more simple version of this app while following David Katz's Udemy course. I love music and I am a Spotify user and it seemed like a good project to learn more about React.",
		coolFeature:
	...
	expensify: {
		...
		why:
			"I made the bulk of this app as the capstone project of Andrew Mead's Udemy course. It used all of the things we learned in the course, and then I added some features of my own.",
		coolFeature:
	...
	hairbyfrancisco: {
		...
		why:
			"Francisco is my barber and his website didn't show off his skills very well. I also wanted to add real work to my résumé.",
		coolFeature:
	...
	sacc: {
		...
		why:
			"Gene Carangal, the founder of the meetup, is a really great guy and I really enjoy attending this meetup. Gene noticed that I was looking for work to boost my résumé, and the website needed a lot of work, and the rest is history.",
		coolFeature:
	...
	yelpcamp: {
		...
		why:
			"I built this app while following Colt Steele's Web Dev Bootcamp Udemy course. This was the final and most complex project of the course.",
		coolFeature:
	...
	calculator: {
		...
		why:
			"This was a project from freeCodeCamp's Advanced Front End Development Projects. I'm a huge math geek, and it seemed like a great introductory challenge for getting accustomed to working with state.",
		coolFeature:
	...
	seasonal: {
		...
		why:
			"I was really fed up with two things: 1) going to the grocery store and only picking the fruit I was familiar with and 2) not knowing whether fruit was ripe or not.",
		coolFeature:
	...
	tictactoe: {
		...
		why:
			"This was a project from freeCodeCamp's Advanced Front End Development Projects. Tic tac toe is a simple game, and so I wanted to see if writing a bot was equally simple. It was not.",
		coolFeature:
	...
	colorconversion: {
		...
		why:
			"I was learning about how colors are represented on the web using hexadecimal numbers or RGB. I figured there was a way to convert, and I was right. I thought making a converter would be a good challenge and help me train myself to be able to see a hexadecimal number and roughly guess the color.",
		coolFeature:
